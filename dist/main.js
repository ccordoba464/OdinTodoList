  ...
  const createProjectForm = () => {
    ...
    submitButton.addEventListener("click", () => {
      ...
      if (nameInput.checkValidity()) {
        _projects__WEBPACK_IMPORTED_MODULE_2__["default"].createProject(nameInput.value);
        projectForm.remove();
      } else {
...
function addButtonListeners() {
  ...
  addProjectButton.addEventListener("click", () => {
    if (!document.getElementById("project-form")) {
      const body = document.querySelector("body");
      let formElement = _modules_element_creation__WEBPACK_IMPORTED_MODULE_0__["default"].createProjectForm();
  ...
  addTasksButton.addEventListener("click", () => {
    if (!document.getElementById("task-form")) {
      const body = document.querySelector("body");
      let formElement = _modules_element_creation__WEBPACK_IMPORTED_MODULE_0__["default"].createTaskForm();
      body.append(formElement);
    }
  });
}
...
function init() {
  addButtonListeners();
  _modules_projects__WEBPACK_IMPORTED_MODULE_1__["default"].createProject("Inbox");
}
