...
const projectTasks = (() => {
  ...
  const tasks = (title, description, dueDate, priority) => {
    dueDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(new Date(dueDate), "MMM dd yyyy");
