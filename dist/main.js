...
const displayController = (() => {
  ...
  const deleteTask = taskObject => {
    ...
    _tasks__WEBPACK_IMPORTED_MODULE_1__["default"].populateTaskSection(currentProject.tasks);
  };
...
/***/ "./src/modules/element-creation.js":
/*!*****************************************!*\
  !*** ./src/modules/element-creation.js ***!
  \*****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const elementCreation = (() => {
  ...
  const expandTask = taskObject => {
    ...
    deleteTaskButton.addEventListener("click", () => {
      expandedTask.remove();
      _display_controller__WEBPACK_IMPORTED_MODULE_0__["default"].deleteTask(taskObject);
    });
...
const projects = (() => {
  ...
  const createProject = title => {
    ...
    _display_controller__WEBPACK_IMPORTED_MODULE_0__["default"].currentProject = projectObject;
...
/* harmony import */ var _element_creation__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./element-creation */ "./src/modules/element-creation.js");
...
const projectTasks = (() => {
  ...
  const tasks = (title, description, dueDate, priority) => {
    if (dueDate) dueDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])(dueDate), "MMM dd yyyy");
  ...
  const createTask = (title, description, dueDate, priority) => {
    ...
    for (let project of _projects__WEBPACK_IMPORTED_MODULE_1__["default"].projectsList) {
      if (_display_controller__WEBPACK_IMPORTED_MODULE_0__["default"].currentProject.title === project.title) {
        const projectsContainer = document.getElementById("projects");
        let projectsCreated = projectsContainer.querySelectorAll(".project");
        projectsCreated.forEach(project => {
          if (project.id === _display_controller__WEBPACK_IMPORTED_MODULE_0__["default"].currentProject.title) {
  ...
  const populateTaskSection = projectTasks => {
    ...
    for (let task of projectTasks) {
      let taskElement = _element_creation__WEBPACK_IMPORTED_MODULE_2__["default"].createTaskElement(task);
      taskElement.addEventListener("click", () => {
        let expandedTask = _element_creation__WEBPACK_IMPORTED_MODULE_2__["default"].expandTask(task);
...
function addButtonListeners() {
  ...
  addProjectButton.addEventListener("click", () => {
    if (!document.getElementById("project-form")) {
      const body = document.querySelector("body");
      let formElement = _modules_display_controller__WEBPACK_IMPORTED_MODULE_0__["default"].createProjectForm();
  ...
  addTasksButton.addEventListener("click", () => {
    if (!document.getElementById("task-form")) {
      const body = document.querySelector("body");
      let formElement = _modules_display_controller__WEBPACK_IMPORTED_MODULE_0__["default"].createTaskForm();
      body.append(formElement);
    }
  });
}
