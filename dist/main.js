...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _tasks_manager__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./tasks-manager */ "./src/modules/tasks-manager.js");
...
/* harmony import */ var _display_controller__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./display-controller */ "./src/modules/display-controller.js");
...
const elementCreation = (() => {
  ...
  const createTaskElement = task => {
    ...
    taskElement.addEventListener("click", () => {
      if (_display_controller__WEBPACK_IMPORTED_MODULE_2__["default"].checkAvailability()) {
  ...
  const expandTask = taskObject => {
    ...
    deleteTaskButton.addEventListener("click", () => {
      expandedTask.remove();
      _tasks_manager__WEBPACK_IMPORTED_MODULE_0__["default"].deleteTask(taskObject);
    });
  ...
  const createProjectForm = () => {
    ...
    submitButton.addEventListener("click", () => {
      ...
      if (nameInput.checkValidity()) {
        _projects_manager__WEBPACK_IMPORTED_MODULE_1__["default"].createProject(nameInput.value);
        projectForm.remove();
      } else {
  ...
  const createTaskForm = () => {
    ...
    submitButton.addEventListener("click", () => {
      event.preventDefault();
      if (nameInput.checkValidity()) {
        _tasks_manager__WEBPACK_IMPORTED_MODULE_0__["default"].createTask(
          nameInput.value,
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _element_creation__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./element-creation */ "./src/modules/element-creation.js");
/* harmony import */ var _projects_manager__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./projects-manager */ "./src/modules/projects-manager.js");
/* harmony import */ var _tasks_manager__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./tasks-manager */ "./src/modules/tasks-manager.js");




const inboxManager = (() => {
  let inbox = _projects_manager__WEBPACK_IMPORTED_MODULE_1__["default"].project("inbox");

  const createIndexElement = () => {
    const projectsContainer = document.getElementById("projects");
    _projects_manager__WEBPACK_IMPORTED_MODULE_1__["default"].selectedProject = inbox;

    let inboxElement = _element_creation__WEBPACK_IMPORTED_MODULE_0__["default"].createInboxElement();
  ...
  const totalTasksPopulation = () => {
    ...
    for (let taskObject of inbox.tasks) {
      let taskElement = _element_creation__WEBPACK_IMPORTED_MODULE_0__["default"].createTaskElement(taskObject);
      projectTasksContainer.appendChild(taskElement);
    }

    for (let project of _projects_manager__WEBPACK_IMPORTED_MODULE_1__["default"].projectsList) {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (inboxManager);
...
/* harmony export */ });
/* harmony import */ var _element_creation__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./element-creation */ "./src/modules/element-creation.js");
/* harmony import */ var _tasks_manager__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./tasks-manager */ "./src/modules/tasks-manager.js");
...
const projectsManager = (() => {
  ...
  const createProject = title => {
    ...
    let projectElement = _element_creation__WEBPACK_IMPORTED_MODULE_0__["default"].createProjectElement(projectObject);

    projectElement.addEventListener("click", () => {
      projectsManager.selectedProject = projectObject;
      _tasks_manager__WEBPACK_IMPORTED_MODULE_1__["default"].populateTaskSection(projectsManager.selectedProject.tasks);
    });
...
/* harmony import */ var _element_creation__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./element-creation */ "./src/modules/element-creation.js");
...
const tasksManager = (() => {
  ...
  const tasks = (title, description, dueDate, priority) => {
    if (dueDate) dueDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(dueDate), "MMM dd yyyy");
  ...
  const createTask = (title, description, dueDate, priority) => {
    ...
    if (_projects_manager__WEBPACK_IMPORTED_MODULE_0__["default"].selectedProject.title !== "inbox") {
      for (let project of _projects_manager__WEBPACK_IMPORTED_MODULE_0__["default"].projectsList) {
        if (_projects_manager__WEBPACK_IMPORTED_MODULE_0__["default"].selectedProject.title === project.title) {
          project.tasks.push(taskObject);
          _projects_manager__WEBPACK_IMPORTED_MODULE_0__["default"].selectedProject = project;
          ...
          projectElementsCreated.forEach(projectElement => {
            if (projectElement.id === _projects_manager__WEBPACK_IMPORTED_MODULE_0__["default"].selectedProject.title) {
      ...
      _projects_manager__WEBPACK_IMPORTED_MODULE_0__["default"].selectedProject.tasks.push(taskObject);

      populateTaskSection(_projects_manager__WEBPACK_IMPORTED_MODULE_0__["default"].selectedProject.tasks);
  ...
  const deleteTask = taskObject => {
    console.log(_projects_manager__WEBPACK_IMPORTED_MODULE_0__["default"].selectedProject);
    for (let project of _projects_manager__WEBPACK_IMPORTED_MODULE_0__["default"].projectsList) {
      if (_projects_manager__WEBPACK_IMPORTED_MODULE_0__["default"].selectedProject.title === project.title) {
    ...
    tasksManager.populateTaskSection(_projects_manager__WEBPACK_IMPORTED_MODULE_0__["default"].selectedProject.tasks);
  };
  ...
  const populateTaskSection = projectTasks => {
    ...
    for (let taskObject of projectTasks) {
      let taskElement = _element_creation__WEBPACK_IMPORTED_MODULE_1__["default"].createTaskElement(taskObject);
      projectTasksContainer.appendChild(taskElement);
    }
  };
...
/* harmony import */ var _modules_element_creation__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/element-creation */ "./src/modules/element-creation.js");
/* harmony import */ var _modules_inbox_manager__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/inbox-manager */ "./src/modules/inbox-manager.js");
...
function addButtonListeners() {
  ...
  addProjectButton.addEventListener("click", () => {
    if (_modules_display_controller__WEBPACK_IMPORTED_MODULE_0__["default"].checkAvailability()) {
      _modules_element_creation__WEBPACK_IMPORTED_MODULE_1__["default"].createProjectForm();
    }
  });
  ...
  addTasksButton.addEventListener("click", () => {
    if (_modules_display_controller__WEBPACK_IMPORTED_MODULE_0__["default"].checkAvailability()) {
      _modules_element_creation__WEBPACK_IMPORTED_MODULE_1__["default"].createTaskForm();
    }
  });
}

function init() {
  _modules_inbox_manager__WEBPACK_IMPORTED_MODULE_2__["default"].createIndexElement();
  addButtonListeners();
}
