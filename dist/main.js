...
const projects = (() => {
  ...
  const createProject = title => {
    ...
    let projectElement = _element_creation__WEBPACK_IMPORTED_MODULE_1__["default"].createProjectElement(projectObject);
