...
const displayController = (() => {
  const displayTasks = projectObject => {
    for (let project of _projects_manager__WEBPACK_IMPORTED_MODULE_0__["default"].projectsList) {
      if (projectObject.title === project.title) {
        ...
        _tasks_manager__WEBPACK_IMPORTED_MODULE_1__["default"].populateTaskSection(project.tasks);
      }
    }
  };
  ...
  const deleteTask = taskObject => {
    ...
    _tasks_manager__WEBPACK_IMPORTED_MODULE_1__["default"].populateTaskSection(_projects_manager__WEBPACK_IMPORTED_MODULE_0__["default"].selectedProject.tasks);
  };
...
/* harmony import */ var _tasks_manager__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./tasks-manager */ "./src/modules/tasks-manager.js");
/* harmony import */ var _projects_manager__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./projects-manager */ "./src/modules/projects-manager.js");
...
const elementCreation = (() => {
  ...
  const createProjectForm = () => {
    ...
    submitButton.addEventListener("click", () => {
      ...
      if (nameInput.checkValidity()) {
        _projects_manager__WEBPACK_IMPORTED_MODULE_2__["default"].createProject(nameInput.value);
        projectForm.remove();
      } else {
  ...
  const createTaskForm = () => {
    ...
    submitButton.addEventListener("click", () => {
      if (nameInput.checkValidity()) {
        _tasks_manager__WEBPACK_IMPORTED_MODULE_1__["default"].createTask(
          nameInput.value,
...
/*!**********************!*\
  ...
  \**********************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _modules_element_creation__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/element-creation */ "./src/modules/element-creation.js");
...
function addButtonListeners() {
  ...
  addProjectButton.addEventListener("click", () => {
    if (!document.getElementById("project-form")) {
      _modules_element_creation__WEBPACK_IMPORTED_MODULE_0__["default"].createProjectForm();
    }
  });
  ...
  addTasksButton.addEventListener("click", () => {
    if (!document.getElementById("task-form")) {
      _modules_element_creation__WEBPACK_IMPORTED_MODULE_0__["default"].createTaskForm();
    }
  });
}
...
function init() {
  addButtonListeners();
  _modules_projects_manager__WEBPACK_IMPORTED_MODULE_1__["default"].createProject("Inbox");
}
